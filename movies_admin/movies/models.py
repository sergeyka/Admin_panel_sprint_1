...
class FilmWorkGenre(models.Model):
    film_work_id = models.ForeignKey(FilmWork, on_delete=models.CASCADE, related_name='genres')
    genre_id = models.ForeignKey(Genre, on_delete=models.CASCADE, related_name='film_works')
